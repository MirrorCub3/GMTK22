...
public class Boss_Roll : StateMachineBehaviour
{
    Transform boss;
    ...
    {
        boss.position = Vector2.MoveTowards(boss.position, target.position, bossScript.rollSpeed * bossScript.speedMultiplier * Time.deltaTime);
    }
